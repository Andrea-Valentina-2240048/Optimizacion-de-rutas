...
class Arbol():
    def __init__(self):
        ...
        self.coliseo = Node("Coliseo UIS", 
                            descripcion="Esta ubicado al sureste del campus, cuenta con una cancha polifuncional, camerinos, oficinas y gradería. Tiene 2 pisos y su fachada es en ladrillo rojizo, tiene unas lineas de colores y su techo tiene un estilo semicurvo.", 
                            Num=4)
        self.luis_a_calvo = Node("Luis A. Calvo", 
                                descripcion="Edificio de 20 metros de altura con una fachada curva en semióvalo y sin ventanas visibles. Está construido en ladrillo rojizo.", 
                                Num=5)
        self.residencias = Node("Residencias de Estudiantes", 
                                descripcion="Edificio de varios pisos con fachada blanca y paneles verticales marrones. Las escaleras laterales conectan todos los niveles.", 
                                Num=6)
        self.estadio = Node("Estadio 1ero de marzo", 
                            descripcion="Estadio con pista de atletismo de ocho carriles, alternando azul claro y oscuro que rodea el campo central.", 
                            Num=7)
        self.canchas = Node("Canchas Múltiples", 
                            descripcion="Área deportiva con varias canchas al aire libre para diversas disciplinas.", 
                            Num=8)
        self.admin1 = Node("Administración 1", 
                            descripcion="Edificio blanco con detalles grises, está compuesto por dos bloques de cuatro y dos pisos. 2 pasillos conectan los bloques en los primeros dos pisos. Tiene ventanas oscuras.", 
                            Num=9)
        self.admin2 = Node("Administración 2", 
                            descripcion="Estructura de cinco pisos de color blanco, con bloques conectados por escaleras.", 
                            Num=10)
        self.admin3 = Node("Administración 3", 
                            descripcion="Compuesto por dos bloques amarillos mostaza, conectados por un puente verde vibrante.", 
                            Num=11)
        self.bienestar_estudiantil = Node("Bienestar Estudiantil", 
                                        descripcion="El complejo está compuesto por tres bloques con diseños diversos. El primero tiene paneles metálicos verdes, el segundo es completamente acristalado y el tercero tiene una terraza.", 
                                        Num=12)
        self.bienestar_campestre = Node("Bienestar Campestre", 
                                        descripcion="Espacio al aire libre con techos verdes y mesas.", 
                                        Num=13)
        self.auditorio_galan = Node("Auditorio José Antonio Galán", 
                                    descripcion="Teatrino pequeño con graderías al aire libre en dos lados, de cinco y seis filas respectivamente. Las gradas son de ladrillo pequeño.", 
                                    Num=14)
        self.casona = Node("Casona La Perla", 
                            descripcion="Edificio de un solo piso de estilo colonial, con techo de tejas de barro y pisos rojizos.", 
                            Num=15)
        self.tienda_universitaria = Node("Tienda Universitaria", 
                                        descripcion="Tiene un letrero con su nombre en la fachada, es de color blanco y azul celeste y está ubicada enfrente del edificio de humanas 2.", 
                                        Num=16)
        self.humanas2 = Node("Humanas 2", 
                            descripcion="Edificio de 9 plantas, color amarillo mostaza, ubicado frente de la portería de la carrera 27.", 
                            Num=17)
        self.mecanica = Node("Ingeniería Mecánica", 
                            descripcion="Edificio blanco de tres pisos, ubicado frente a biblioteca y al lado del auditorio Luis Eduardo Lobo, tiene tres entradas.", 
                            Num=18)
        self.humanas1 = Node("Humanas 1", 
                            descripcion="Edificio de cinco pisos, con muro de ladrillo, se identifica por su planetario en la última planta.", 
                            Num=19)
        self.lab_livianos = Node("Laboratorio de Livianos", 
                                descripcion="Construcción de cuatro pisos, de color blanco, ubicado después del edificio de humanas y unido por un pasillo al tercer piso del Camilo Torres.", 
                                Num=20)
        self.edic = Node("EDIC", 
                        descripcion="El Edificio de Investigaciones de la Facultad de Ciencias, está constituido por 8 niveles, se distingue por su color crema, casi amarillo, y por su fachada con pequeñas ventanas blancas y cafés. Está ubicado junto al Laboratorio de Livianos.", 
                        Num=21)
        self.auditorio_lobo = Node("Auditorio Luis Eduardo Lobo", 
                                    descripcion="Este auditorio, de estructura semicircular, se encuentra junto al edificio Camilo Torres. Su techo es de color gris y el resto de la fachada es blanca.", 
                                    Num=22)
        self.biblioteca = Node("Biblioteca", 
                                descripcion="Edificio de cuatro plantas con una estructura de lápices verticales y con vista al interior.", 
                                Num=23)
        self.instituto_lenguas = Node("Instituto de Lenguas", 
                                    descripcion="Este edificio actualmente se encuentra en construcción.", 
                                    Num=24)
        self.federico = Node("Federico Mamitza Bayer", 
                            descripcion="Edificio de muro de ladrillo, 3 plantas y reja amplia para el ingreso.", 
                            Num=25)
        self.ingenieria_industrial = Node("Ingeniería Industrial", 
                                        descripcion="Este edificio cuenta con 5 pisos, tiene en su entrada un letrero con su nombre 'Ingeniería Industrial'. Es de color blanco y gris, cuenta con una rampa a la derecha y escaleras al frente para el ingreso.", 
                                        Num=26)
        self.ingenieria_e3t = Node("Ingeniería E3T", 
                                descripcion="En este edificio se encuentran la Escuela de Ingenierías Eléctrica, Electrónica y de Telecomunicaciones y cuenta con 4 pisos. Es de color blanco y gris, con puertas de vidrio, y se identifica por su letrero de 'E3T' en la parte superior izquierda de su entrada. Está ubicado junto al edificio de Ingeniería Industrial.", 
                                Num=27)
        self.diseno_industrial = Node("Diseño Industrial", 
                                    descripcion="Construcción de un solo piso, con tejado visible.", 
                                    Num=28)
        self.alta_tension = Node("Laboratorios de Alta Tensión", 
                                descripcion="Este edificio es de color blanco y tiene dos pisos.", 
                                Num=29)
        self.camilo_torres = Node("Camilo Torres", 
                                descripcion="Este edificio de 5 pisos está construido en ladrillo de color rojizo, se destaca por tener en su fachada la imagen del sacerdote y activista colombiano Camilo Torres.", 
                                Num=30)
        self.centic = Node("CENTIC", 
                        descripcion="Edificio de cómputo de la universidad, pintado de blanco y 4 pisos, con cristales en el exterior en la parte frontal y trasera.", 
                        Num=31)
        self.ingenieria_quimica = Node("Ingeniería Química", 
                                    descripcion="Este edificio cuenta con dos niveles, se reconoce por su nombre en letras rojas en la parte superior y por la escultura llamada Torre de Destilación ubicada en su entrada, que representa una torre utilizada en los laboratorios de procesos de ingeniería química. Su fachada es de color blanco.", 
                                    Num=32)
        self.jorge_bautista_vesga = Node("Jorge Bautista Vesga", 
                                        descripcion="Edificio de escuela de Ingeniería Metalúrgica y Ciencia de Materiales, 3 pisos, con muro de ladrillo y al final de la calle.", 
                                        Num=33)
        self.fisicomecanica = Node("Ingenierías Físico-Mecánicas", 
                                descripcion="Esta facultad cuenta con 4 niveles, está construida en ladrillo de color rojizo, en su entrada se puede apreciar un letrero con su nombre y se identifica principalmente por la figura denominada Corte de construcción al Viento construida en hierro y PVC.", 
                                Num=34)
        self.uisalud = Node("Uisalud", 
                            descripcion="Este edificio cuenta con 3 pisos, tiene su nombre en grande en la fachada, es de colores gris y blanco, y cuenta con varios ventanales. Está ubicado detrás del CENTIC y junto al Aula Máxima de Ciencias.", 
                            Num=35)
